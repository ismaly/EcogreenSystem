        ...
        <div id="content-wrapper" class="d-flex flex-column">
           ...
           <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Monitoring Sampah</h1>
                </div>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 200px;"><b>No Hp</b></th>
                                            <th><b>Pekerjaan</b></th>
                                            <th><b>Fakultas</b></th>
                                            <th><b>Jenis Sampah</b></th>
                                            <th><b>Total Sampah (KG)</b></th>
                                            <th style="width: 300px;"><b>Bukti Pengumpulan</b></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data->nama }}</td>
                                            <td>{{ $data->nim }}</td>
                                            <td style="width: 200px;">{{ $data->nohp }}</td>
                                            ...
                                            <td style="width: 300px;">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>Pekerjaan: {{ $data->pekerjaan }}</p>
                                                        <p>Pekerjaan: {{ $data->jenis_sampah }}</p>
                                                        <p>Pekerjaan: {{ $data->total }}</p>
                                                        <p>Bukti Pegumpulan Sampah: </p>
                                                        @if ($data->formFile)
