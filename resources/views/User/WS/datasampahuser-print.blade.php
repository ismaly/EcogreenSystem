...
<body>
    ...
    <hr color="#00000">
    <p align="center" style="font-size: 20px"><b>Data Pengumpulan Sampah {{ $datasampahuser->nama }}</b></p>
    <br>
    <br>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->nama }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->nim }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->nohp }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->pekerjaan }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->getFakultasLabelAttribute() }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    <td width="150px;"><b>Jenis Sampah</b></td>
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->jenis_sampah }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->total }} (Kg)</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">
                        @if ($datasampahuser->formFile)
                        <img src="{{ asset('storage/images/' . $datasampahuser->formFile) }}" alt="" style="width: 200px;">
                        @else
                        Tidak ada gambar
                        @endif
                    </td>
            ...
            <tr>
                <td>
                    <td width="150px;"><b>Created</b></td>
                    <td>:</td>
                    <td width="150px;">{{ Carbon\Carbon::parse($datasampahuser->created_at)->locale('id')->isoFormat('dddd, D MMMM YYYY') }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->keterangan }}</td>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <td>:</td>
                    <td width="150px;">{{ $datasampahuser->status }}</td>
                </td>
            </tr>
        </tbody>
    </table>
